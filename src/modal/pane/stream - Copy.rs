...
const NUMERIC_INPUT_BUF_SIZE: usize = 20; // Increased to support decimals

const TICK_COUNT_MIN: u16 = 4;
const TICK_COUNT_MAX: u16 = 1000;

const TICK_MULTIPLIER_MIN: f64 = 0.00000001;
const TICK_MULTIPLIER_MAX: f64 = f64::MAX; // Uncapped
                ...
                if let Some(ticksize) = selected_ticksize {
                    ...
                    let allowed_tm = if allows_custom_tsizes {
                        ...
                        exchange::TickMultiplier::ALL
                            .iter()
                            .copied()
                            .filter(|tm| allow.contains(&(tm.0 as u16)))
                            .collect()
                    };
